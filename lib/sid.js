(function() {
  ...
  parse = function(str, opts) {
    var item, parent, parents, s, _i, _len, _ref, _ref1;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      switch (s.type) {
        ...
        case T_ITEM:
          ...
          if (s.value != null) {
            item.value = typeof s.value === 'function' ? s.value(opts) : s.value;
          }
          ((_ref1 = parent.children) != null ? _ref1 : parent.children = []).push(item);
          break;
        default:
